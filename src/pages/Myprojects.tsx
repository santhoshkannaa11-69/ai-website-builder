...
import { FastForward, Loader2Icon, PlusIcon, TrashIcon } from "lucide-react";
                    ...
                    <div className="py-10 min-h-[80vh]">
                        ...
                        <div className="flex flex-wrap gap-3.5">
                            {projects.map((project)=>(
                                <div onClick={()=> navigate(`/projects/${project.id}`)} key={project.id} className="relative group w-72 max-sm:mx-auto cursor-pointer bg-gray-900/60 border border-gray-700 rounded-lg overflow-hidden shadow-md group transition-all duration-300">
                                    ...
                                    <div className="p-4 text-white bg-gradient-to-b from-transparent group-hover:from-indigo-950 to-transparent transition-colors">
                                        <div className="flex items-start justify-between">
                                            ...
                                            <button className="px-2.5 py-0.5 mt-1 ml-2 text-xs bg-gray-800 border-gray-700 rounded-full">
                                                Website
                                            </button>
                                        </div>
